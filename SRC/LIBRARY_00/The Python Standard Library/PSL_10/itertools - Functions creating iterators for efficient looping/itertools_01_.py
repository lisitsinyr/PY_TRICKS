...
#beginfunction
    ...
    # | product | productКомбинация, полученная из всех возможных значений вложенных списков | list(product([1, 2], repeat=2)) --> [(1, 1), (1, 2), (2, 1), (2, 2)] |
    # |-------- 3 --------|---------------|-----------------|
    ...
    # | tee | Возвращает n независимых итераторов из одного итерируемого объекта |
    # tee([1, 2, 3], 3) --> [1, 2, 3] [1, 2, 3] [1, 2, 3] |
